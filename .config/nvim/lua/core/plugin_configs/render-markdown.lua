...
vim.cmd(string.format([[highlight RenderMarkdownH1Bg guifg=%s guibg=%s]], color_fg, color_bg1))
vim.cmd(string.format([[highlight RenderMarkdownH2Bg  guifg=%s guibg=%s]], color_fg, color_bg2))
vim.cmd(string.format([[highlight RenderMarkdownH3Bg  guifg=%s guibg=%s]], color_fg, color_bg3))
vim.cmd(string.format([[highlight RenderMarkdownH4Bg  guifg=%s guibg=%s]], color_fg, color_bg4))

-- Highlight for the heading and sign icons (symbol on the left)
-- I have the sign disabled for now, so this makes no effect
vim.cmd(string.format([[highlight RenderMarkdownH1 cterm=bold gui=bold guifg=%s]], color_bg1))
vim.cmd(string.format([[highlight RenderMarkdownH2 cterm=bold gui=bold guifg=%s]], color_bg2))
vim.cmd(string.format([[highlight RenderMarkdownH3 cterm=bold gui=bold guifg=%s]], color_bg3))
vim.cmd(string.format([[highlight RenderMarkdownH4 cterm=bold gui=bold guifg=%s]], color_bg4))

vim.cmd(string.format([[highlight RenderMarkdownTableHead cterm=bold gui=bold guifg=%s]], color_bg2))
vim.cmd(string.format([[highlight RenderMarkdownTableRow cterm=bold gui=bold guifg=%s]], color_bg3))

vim.cmd(string.format([[highlight @markup.list cterm=bold gui=bold guifg=%s]], "#FE9C5E"))
