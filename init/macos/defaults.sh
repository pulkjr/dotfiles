...
# Delay before key repeat starts (higher = longer hold required before repeat)
# 15 = ~250ms, 20 = ~333ms, 25 = ~416ms — use https://mac-key-repeat.zaymon.dev to tune
defaults write -g InitialKeyRepeat -int 20

# Rate of repeat once started (lower = faster, minimum is 1)
...
defaults write com.apple.WindowManager ClickWallpaperRevealDesktop -bool false && killall Dock
